...
global $connection;
$red = mysqli_query($connection,"SELECT * FROM employee WHERE emp_name = '{$employee}'");
$data = mysqli_fetch_assoc($red);

$pdf->cell(47.25, 7,"{$data['employee_id']}", 1, 0);
...
$pdf->cell(47.25, 7,'Monthly Deduction', 1, 0);
